...
RUN chmod 777 __init__.py && chmod 777 plink_linux_x86_64_20201019/* && chmod 777 dis_calc/* && chmod 777 dis_calc_app/* && chmod 777 ancestry_mirror-master/src/ancestry 
